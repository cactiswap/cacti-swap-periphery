...
import "../libraries/CactiOracleLibrary.sol";
...
contract ExampleSlidingWindowOracle {
    ...
    function update(address tokenA, address tokenB) external {
        ...
        if (timeElapsed > periodSize) {
            (uint256 price0Cumulative, uint256 price1Cumulative, ) =
                CactiOracleLibrary.currentCumulativePrices(pair);
    ...
    function consult(
        ...
        address pair = CactiLibrary.pairFor(factory, tokenIn, tokenOut);
        ...
        (uint256 price0Cumulative, uint256 price1Cumulative, ) =
            CactiOracleLibrary.currentCumulativePrices(pair);
        (address token0, ) = CactiLibrary.sortTokens(tokenIn, tokenOut);
